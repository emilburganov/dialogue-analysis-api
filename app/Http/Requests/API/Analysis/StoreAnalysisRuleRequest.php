...
class StoreAnalysisRuleRequest extends FormRequest
{
    ...
    {
        return [
            'rule_type_id' => ['required', 'integer', Rule::exists('analysis_rule_types', 'id')],
    ...
    {
        return [
            'rule_type_id.required' => 'Выберите тип правила.',
            'rule_type_id.exists' => 'Выбран неизвестный тип правила.',
